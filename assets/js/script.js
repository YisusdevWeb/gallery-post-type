jQuery(document).ready(function ($) {
    ...
    function mostrarGaleriaPreview(galeria) {
        ...
        galeria.forEach(function (imagen_url) {
            previewContainer.append('<div class="galeria-item"><img src="' + imagen_url + '" alt="" style="max-width: 100px; margin-right: 10px;"><button class="eliminar-imagen button" data-imagen="' + imagen_url + '">X</button></div>');
        });
    }
});